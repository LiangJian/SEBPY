...
# XMBF_class.HandleInput.init()
# XMBF_class.HandleInput.walk_data(XMBF_class.HandleInput, XMBF_class.HandleInput.root)
...
XMBF_class.XmbfIo.init(N_conf, N_t, K, V, 'proton-wp.txt')
XMBF_class.XmbfIo.read_data_file()
XMBF_class.XmbfIo.write_data_file()
